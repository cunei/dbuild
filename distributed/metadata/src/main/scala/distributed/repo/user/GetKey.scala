 ...
 */
case class GetRaw private[repo] (private[repo] uuid: String) extends GetKey[InputStream]
/**
...
case class GetProject private[repo] (private[repo] uuid: String) extends GetMeta[RepeatableProjectBuild]
case class GetBuild private[repo] (private[repo] uuid: String) extends GetMeta[SavedConfiguration]
case class GetExtract private[repo] (private[repo] uuid: String) extends GetMeta[ExtractedBuildMeta]
...
case class GetArtifacts private[repo] (private[repo] uuid: String) extends GetMeta[BuildArtifactsOut]
