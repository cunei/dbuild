...
case class ResolveException(msg: String) extends java.lang.RuntimeException(msg) with RepositoryException
/** We had issues reading the metadata, but it did exist. */
case class MalformedMetadata(msg: String) extends java.lang.RuntimeException(msg) with RepositoryException
/** We had an issue attempting to store the artifact in the cache. */
case class StoreException(msg: String) extends java.lang.RuntimeException(msg) with RepositoryException
